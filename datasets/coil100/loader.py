...
def get_image(
        cls,
        index,
        path='/home/i18_t_tatsukawa/coil-100',
        img_size=128):

    filename = 'obj{}__{}.png'.format(cls, index*5)
    ...
    return x.reshape((3, img_size, img_size))
...
def get_ref_and_real_data(indexes,
                          dim_noise=3,
                          img_size=128,
                          path='/home/i18_t_tatsukawa/coil-100',
                          dif_index=1):
    ...
    for index in indexes:
        ...
        cls = math.floor(index / NUM_DATA_PER_CLASS) + 1 # class0は存在しない
        num = index % NUM_DATA_PER_CLASS
        ...
        next_index = (num + dif + NUM_DATA_PER_CLASS) % NUM_DATA_PER_CLASS
